...
public class SelectionController extends LabeledFieldController {
    ...
    private final static int SPINNER_ID = R.id.spinner_id;
    ...
    public SelectionController(Context ctx, String name, String labelText, boolean isRequired, HashMap<?,String> valuesMap)
    {
        super(ctx, name, labelText, isRequired);
        this.items = new ArrayList<>();
        this.items.addAll(valuesMap.values());
        Set<?> values = valuesMap.keySet();
    ...
    protected View createFieldView() {
        Spinner spinnerView = (Spinner) LayoutInflater.from(getContext()).inflate(R.layout.spinner,null);
        ...
        {
            getModel().setValue(getName(),mDefaultValue);
        }
        refresh(spinnerView);
        return spinnerView;
    }
